...
#define LEDR_GPIO_PORT_NUM              5
#define LEDR_GPIO_BIT_NUM               0
#define LEDG_GPIO_PORT_NUM              5
#define LEDG_GPIO_BIT_NUM               1
#define LEDB_GPIO_PORT_NUM              5
#define LEDB_GPIO_BIT_NUM               2
...
#define BUTTONS_TEC2_GPIO_PORT_NUM   0
#define BUTTONS_TEC2_GPIO_BIT_NUM    8
#define BUTTONS_TEC3_GPIO_PORT_NUM   0
#define BUTTONS_TEC3_GPIO_BIT_NUM    9
#define BUTTONS_TEC4_GPIO_PORT_NUM   1
#define BUTTONS_TEC4_GPIO_BIT_NUM    9
